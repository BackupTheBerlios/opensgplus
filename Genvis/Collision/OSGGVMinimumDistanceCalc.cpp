...
template class OSG_GENVISLIB_DLLMAPPING MinimumDistanceCalc<OpenSGTraits,K6Dop,EuclideanMetric>;
template class OSG_GENVISLIB_DLLMAPPING MinimumDistanceCalc<OpenSGTraits,K12Dop,EuclideanMetric>;
template class OSG_GENVISLIB_DLLMAPPING MinimumDistanceCalc<OpenSGTraits,K20Dop,EuclideanMetric>;
template class OSG_GENVISLIB_DLLMAPPING MinimumDistanceCalc<OpenSGTraits,K14Dop,EuclideanMetric>;
template class OSG_GENVISLIB_DLLMAPPING MinimumDistanceCalc<OpenSGTraits,K18Dop,EuclideanMetric>;
template class OSG_GENVISLIB_DLLMAPPING MinimumDistanceCalc<OpenSGTraits,K26Dop,EuclideanMetric>;

template class OSG_GENVISLIB_DLLMAPPING MinimumDistanceCalcTraits<OpenSGTraits,K6Dop,EuclideanMetric>;
template class OSG_GENVISLIB_DLLMAPPING MinimumDistanceCalcTraits<OpenSGTraits,K12Dop,EuclideanMetric>;
template class OSG_GENVISLIB_DLLMAPPING MinimumDistanceCalcTraits<OpenSGTraits,K20Dop,EuclideanMetric>;
template class OSG_GENVISLIB_DLLMAPPING MinimumDistanceCalcTraits<OpenSGTraits,K14Dop,EuclideanMetric>;
template class OSG_GENVISLIB_DLLMAPPING MinimumDistanceCalcTraits<OpenSGTraits,K18Dop,EuclideanMetric>;
template class OSG_GENVISLIB_DLLMAPPING MinimumDistanceCalcTraits<OpenSGTraits,K26Dop,EuclideanMetric>;


template <class BasicTraits, class BVOL, class Metric>
MinimumDistanceCalc<BasicTraits,BVOL,Metric>::MinimumDistanceCalc ()
  : Inherited()
{
}

template <class BasicTraits, class BVOL, class Metric>
bool MinimumDistanceCalc<BasicTraits,BVOL,Metric>::Init ()
{
   Inherited::Init();
