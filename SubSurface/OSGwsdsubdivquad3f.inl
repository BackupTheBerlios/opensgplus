...
template<>
void WSDsubdiv<OSG::Vec3f, QUAD>::vertexpoint
(VectorType& v, 
...
template<>
void WSDsubdiv<OSG::Vec3f, QUAD>::edgepoint
(VectorType& v, 
...
template<>
void WSDsubdiv<OSG::Vec3f, QUAD>::facepoint
...
template<>
void WSDsubdiv<OSG::Vec3f, QUAD>::vertexpointcrease
...
template<>
void WSDsubdiv<OSG::Vec3f, QUAD>::innernormal
(OSG::UInt32& nwi, 
 VectorType& v0, VectorType& v1, VectorType& v2, VectorType& v3, VectorType& v4, 
 VectorType& w1, VectorType& w2, VectorType& w3, VectorType& w4)
{   
...
template<>
void WSDsubdiv<OSG::Vec3f, QUAD>::innernormalmulti
...
template<>
void WSDsubdiv<OSG::Vec3f, QUAD>::creasenormal
(OSG::UInt32& nwi, OSG::Vec3f& v0, OSG::Vec3f *array, OSG::Int32 val, OSG::Int32 a, OSG::Int32 b)
{   
	OSG::Vec3f v;
   OSG::Vec3f t1(0.0,0.0,0.0);
   OSG::Vec3f t2(0.0,0.0,0.0);
	...
	else
	{
		...
		OSG::Vec3f betat1 = array[a] * b0;
		OSG::Vec3f gammat1 = array[(a+1)%(val*2)] * c;
...
template<>
void WSDsubdiv<OSG::Vec3f, QUAD>::regcreasenormal
(OSG::UInt32& nwi, VectorType& v0, VectorType& v1, 
 VectorType& w1, VectorType& v2, VectorType& w2, VectorType& v3)
{   
	OSG::Vec3f v;
   OSG::Vec3f t1(0.0,0.0,0.0);
   OSG::Vec3f t2(0.0,0.0,0.0);
	...
	OSG::Real32 b0 = -1.0 * rk * (1.0 + 2.0 * osgcos(pidk));
	OSG::Real32 c = osgsin(pidk) / ((3.0 + osgcos(pidk)) * k);
	OSG::Vec3f betat1 = v1 * b0;
	OSG::Vec3f gammat1 = w1 * c;
...
template<>
void WSDsubdiv<OSG::Vec3f, QUAD>::limitpoint
(OSG::UInt32& lwi, 
 VectorType& v0, VectorType& v1, VectorType& v2, VectorType& v3, VectorType& v4, 
 VectorType& w1, VectorType& w2, VectorType& w3, VectorType& w4)
{
...
template<>
void WSDsubdiv<OSG::Vec3f, QUAD>::limitpointcrease
...
template<>
void WSDsubdiv<OSG::Vec3f, QUAD>::limitpointmulti
(OSG::UInt32& lwi, VectorType& v0, VectorType *array, OSG::Int32 val)
{
	...
	OSG::Vec3f v4(0.0,0.0,0.0,0.0);
	OSG::Vec3f w4(0.0,0.0,0.0,0.0); //; w4.setValues
	for (OSG::Int32 i=0; i<(val*2); i=i+2) {
		v4 = v4 + array[i + 1];	
		w4 = w4 + array[i];
	}		
...
template<>
void WSDsubdiv<OSG::Vec3f, QUAD>::initwsdsubdiv(void)
{
}
...
// update corners data
template<>
void WSDsubdiv<OSG::Vec3f, QUAD>::corsupdate(void)
{
	...
	OSG::Vec3f rep0,rep1,rep2,rep3,rep4,rep5,rep6,rep7;		
...
template<>
void WSDsubdiv<OSG::Vec3f, QUAD>::inneredgerow
...
template<>
void WSDsubdiv<OSG::Vec3f, QUAD>::firstedgerow (void)
{
...
template<>
void WSDsubdiv<OSG::Vec3f, QUAD>::edgerow (OSG::Int32 ri, OSG::Int32 wi)
{
   OSG::Int32 i=0;
   OSG::Int32 j=0;
   OSG::Vec3f* tabA = ppatch->ptabA;
...
template<>
void WSDsubdiv<OSG::Vec3f, QUAD>::lastedgerow (OSG::Int32 ri, OSG::Int32 wi)
{
...
template<>
void WSDsubdiv<OSG::Vec3f, QUAD>::innervertexrow
(OSG::Int32 ri, OSG::Int32 wi, OSG::Int32& i, OSG::Int32& j)
{
	OSG::Vec3f* tabA = ppatch->ptabA;
	OSG::Vec3f* tabB = ppatch->ptabB;
...
template<>
void WSDsubdiv<OSG::Vec3f, QUAD>::creaseinnervertexrow
...
template<>
void WSDsubdiv<OSG::Vec3f, QUAD>::firstvertexrow (void)
{
	// regular case:
	//vertexrow(1,1);
	// valenz>=4:
...
template<>
void WSDsubdiv<OSG::Vec3f, QUAD>::vertexrow (OSG::Int32 ri, OSG::Int32 wi)
{  
	OSG::Int32 i=0;
	OSG::Int32 j=0;
	OSG::Vec3f* tabA = ppatch->ptabA;
...
template<>
void WSDsubdiv<OSG::Vec3f, QUAD>::lastvertexrow (OSG::Int32 ri, OSG::Int32 wi)
{   
	OSG::Int32 i=0;
	OSG::Int32 j=0;
   	OSG::Int32 val1 = ppatch->valenz[1];
...
template<>
void WSDsubdiv<OSG::Vec3f, QUAD>::innerlimitrow
...
template<>
void WSDsubdiv<OSG::Vec3f, QUAD>::creaseinnerlimitlastrow
(OSG::Int32 ri, OSG::UInt32& lwi, OSG::Int32& i, OSG::UInt32& nwi)
{
   OSG::Vec3f* tabA = ppatch->ptabA;
   OSG::Int32 bA=ppatch->breiteA;
...
template<>
void WSDsubdiv<OSG::Vec3f, QUAD>::creaseinnerlimitfirstrow
(OSG::Int32 ri, OSG::UInt32& lwi, OSG::Int32& i, OSG::UInt32& nwi)
{
   OSG::Vec3f* tabA = ppatch->ptabA;
   OSG::Int32 bA=ppatch->breiteA;
...
template<>
void WSDsubdiv<OSG::Vec3f, QUAD>::firstlimitrow (OSG::UInt32 &lwi)
{
...
template<>
void WSDsubdiv<OSG::Vec3f, QUAD>::limitrow (OSG::Int32 ri, OSG::UInt32 &lwi)
{
   OSG::Vec3f* tabA = ppatch->ptabA;
   OSG::Int32 bA=ppatch->breiteA;
   OSG::Int32 i=1;
...
template<>
void WSDsubdiv<OSG::Vec3f, QUAD>::lastlimitrow (OSG::UInt32 &lwi)
{     
   //vertical step in the vertex/normal array:
   OSG::Int32 step = zweihoch[(wsdmaxdepth - targetdepth)];
   lwi-=step;   
