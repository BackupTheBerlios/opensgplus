...
template<>
void WSDsubdiv<OSG::Vec4f, QUAD>::vertexpoint(OSG::Vec4f& v, OSG::Vec4f& v0, OSG::Vec4f& v1, 
     OSG::Vec4f& v2, OSG::Vec4f& v3, OSG::Vec4f& v4, OSG::Vec4f& w1, OSG::Vec4f& w2, OSG::Vec4f& w3, 
     OSG::Vec4f& w4);
template<>
void WSDsubdiv<OSG::Vec4f, QUAD>::vertexpointmulti(OSG::Vec4f& v, OSG::Vec4f& v0,  
     OSG::Vec4f* array, OSG::Int32 val);
template<>
void WSDsubdiv<OSG::Vec4f, QUAD>::edgepoint(OSG::Vec4f& v, OSG::Vec4f& v1, OSG::Vec4f& v2, 
     OSG::Vec4f& w1, OSG::Vec4f& w2,OSG::Vec4f& w3, OSG::Vec4f& w4, OSG::Int32 crease);
template<>
void WSDsubdiv<OSG::Vec4f, QUAD>::facepoint(OSG::Vec4f& v, OSG::Vec4f& v1, OSG::Vec4f& v2, 
                                            OSG::Vec4f& v3, OSG::Vec4f& v4);
template<>
void WSDsubdiv<OSG::Vec4f, QUAD>::vertexpointcrease(OSG::Vec4f& v, OSG::Vec4f& v0, OSG::Vec4f& v1, 
     OSG::Vec4f& v2);
template<>
void WSDsubdiv<OSG::Vec4f, QUAD>::innernormal(OSG::UInt32& nwi, OSG::Vec4f& v0, OSG::Vec4f& v1, 
     OSG::Vec4f& v2, OSG::Vec4f& v3, OSG::Vec4f& v4, OSG::Vec4f& w1, OSG::Vec4f& w2, OSG::Vec4f& w3, 
     OSG::Vec4f& w4);
template<>
void WSDsubdiv<OSG::Vec4f, QUAD>::innernormalmulti(OSG::UInt32& nwi, 
     OSG::Vec4f *array, OSG::Int32 val);
template<>
void WSDsubdiv<OSG::Vec4f, QUAD>::creasenormal(OSG::UInt32& nwi, OSG::Vec4f& v0, 	 
     OSG::Vec4f *array, OSG::Int32 val, OSG::Int32 a, OSG::Int32 b);
template<>
void WSDsubdiv<OSG::Vec4f, QUAD>::regcreasenormal(OSG::UInt32& nwi, OSG::Vec4f& v0, 	 
     OSG::Vec4f& v1, OSG::Vec4f& w1, OSG::Vec4f& v2, OSG::Vec4f& w2, OSG::Vec4f& v3);
template<>
void WSDsubdiv<OSG::Vec4f, QUAD>::limitpoint(OSG::UInt32& lwi, OSG::Vec4f& v0, OSG::Vec4f& v1, 
     OSG::Vec4f& v2, OSG::Vec4f& v3, OSG::Vec4f& v4, OSG::Vec4f& w1, OSG::Vec4f& w2, OSG::Vec4f& w3, 
     OSG::Vec4f& w4);
template<>
void WSDsubdiv<OSG::Vec4f, QUAD>::limitpointcrease(OSG::UInt32& lwi, OSG::Vec4f& v0, OSG::Vec4f& v1, 
     OSG::Vec4f& v2);
template<>
void WSDsubdiv<OSG::Vec4f, QUAD>::limitpointmulti(OSG::UInt32& lwi, OSG::Vec4f& v0, 
     OSG::Vec4f *array, OSG::Int32 val);
...
{	
    ...
    else  v=Vec4f(0,0,0,0);	// error case      
}
//////////////////////////////////////////////////////////////////////
// update corners data
template<>
...
template<>
void WSDsubdiv<OSG::Vec4f, QUAD>::inneredgerow(OSG::Int32 ri, OSG::Int32 wi, OSG::Int32& i, OSG::Int32& j)
{
   OSG::Vec4f* tabA = ppatch->ptabA;
   OSG::Vec4f* tabB = ppatch->ptabB;
   	OSG::Int32 bA=ppatch->breiteA;
	OSG::Int32 bB=wsdmaxindex;   
...
template<>
void WSDsubdiv<OSG::Vec4f, QUAD>::edgerow(OSG::Int32 ri, OSG::Int32 wi)
{
   OSG::Int32 i=0;
   OSG::Int32 j=0;
   OSG::Vec4f* tabA = ppatch->ptabA;
...
template<>
void WSDsubdiv<OSG::Vec4f, QUAD>::lastedgerow(OSG::Int32 ri, OSG::Int32 wi)
{
...
template<>
void WSDsubdiv<OSG::Vec4f, QUAD>::innervertexrow(OSG::Int32 ri, OSG::Int32 wi, OSG::Int32& i, OSG::Int32& j)
{
	OSG::Vec4f* tabA = ppatch->ptabA;
	OSG::Vec4f* tabB = ppatch->ptabB;
	OSG::Int32 bA=ppatch->breiteA;
...
template<>
void WSDsubdiv<OSG::Vec4f, QUAD>::creaseinnervertexrow(OSG::Int32 ri, OSG::Int32 wi, OSG::Int32& i, OSG::Int32& j, OSG::Int32 ce)
{
   OSG::Vec4f* tabA = ppatch->ptabA;
   OSG::Vec4f* tabB = ppatch->ptabB;
   OSG::Int32 bA=ppatch->breiteA;
...
void WSDsubdiv<OSG::Vec4f, QUAD>::firstvertexrow(void)
{
	...
	/*if (val0 > 3)			// val0 = 4	
	edgepoint(tabB[wi][j], 
      tabA[ri][i],tabA[ri][i+1], 
      tabA[ri+1][i],tabA[ri+1][i+1],
      tabA[ri-1][i+1],corA[0][6],ppatch->crease[2]);
	}
	else					// val0 = 3*/	
		edgepoint(tabB[wi*bB+j], 
		  tabA[ri*bA+i],tabA[ri*bA+i+1], 
...
template<>
void WSDsubdiv<OSG::Vec4f, QUAD>::innerlimitrow(OSG::Int32 ri, OSG::UInt32& lwi, OSG::Int32& i, OSG::UInt32& nwi)
{
   OSG::Vec4f* tabA = ppatch->ptabA;
   OSG::Int32 bA=ppatch->breiteA;
...
template<>
void WSDsubdiv<OSG::Vec4f, QUAD>::creaseinnerlimitlastrow(OSG::Int32 ri, OSG::UInt32& lwi, OSG::Int32& i, OSG::UInt32& nwi)
{
   OSG::Vec4f* tabA = ppatch->ptabA;
   OSG::Int32 bA=ppatch->breiteA;
   for(; i<ppatch->tabsize-2;++i) {
...
template<>
void WSDsubdiv<OSG::Vec4f, QUAD>::creaseinnerlimitfirstrow(OSG::Int32 ri, OSG::UInt32& lwi, OSG::Int32& i, OSG::UInt32& nwi)
{
   OSG::Vec4f* tabA = ppatch->ptabA;
   OSG::Int32 bA=ppatch->breiteA;
   for(; i<ppatch->tabsize-2;++i) {
     ...
     OSG::Vec4f& w1, OSG::Vec4f& w2,OSG::Vec4f& w3, OSG::Vec4f& w4, OSG::Int32 crease)
{
	...
	{
		v= (v1 + v2)*0.5;
		//SLOG << "crease detected at edge!" << std::endl;
	}
}
...
/*template<>
void WSDsubdiv<OSG::Vec4f, QUAD>::edgepointold(OSG::Vec4f& v, OSG::Vec4f& v1, OSG::Vec4f& v2, 
     OSG::Vec4f& w1, OSG::Vec4f& w2,OSG::Vec4f& w3, OSG::Vec4f& w4)
{
   v= (v1 + v2)*0.375 + (w1 + w2 + w3 + w4)*0.0625;
}*/
