...
public:
    ...
    //! get a vertex
    Pnt3f getVertex(unsigned int number);
    ...
    //! Get the scale parameters used to create texture coordinates from vertex positions
    Vec3f getTextureScale() const;

    //! Get the translation parameters used to create texture coordinates from vertex positions
    Vec3f getTextureTranslate() const;
